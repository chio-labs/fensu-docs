---
title: Dagster Rule Pack
description: "Activate the standalone Dagster architecture policy, follow its intended repository shape, and configure autoload boundaries."
---
