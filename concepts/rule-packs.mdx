...
framework-specific rules with transparent aliases of compatible core or pack rules,
...
that prefix. The Dagster, TypeScript, and SvelteKit packs own `FPDG`, `FPTS`, and
`FPSK`.
