...
be canonical target-relative POSIX paths. Intentional-layout paths skip aggregate
...
the result. This remains true even when rule selection would hide that diagnostic.
